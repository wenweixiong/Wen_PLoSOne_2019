...
# Remove Inf value
results <- results[-which(is.infinite(results$fc.brca)), ]

# Replace KIR2DL3 value with next highest value
results$fc.brca[which(results$genes=="KIR2DL3")] <- sort(results$fc.brca, decreasing=TRUE)[2]
...
# Volcano plot
    ...
    # Sava plot
    ggsave("Figures/Figure_2E.pdf", plot, width=8, height=8)
